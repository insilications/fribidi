...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600337116
...
export LDFLAGS="${LDFLAGS_GENERATE}"
 %configure  --enable-shared --enable-static --disable-docs
make  V=1 VERBOSE=1
...
%configure  --enable-shared --enable-static --disable-docs --libdir=/usr/lib32 --build=i686-generic-linux-gnu --host=i686-generic-linux-gnu --target=i686-clr-linux-gnu
make  V=1 VERBOSE=1
popd
