...
Source0  : https://github.com/fribidi/fribidi/releases/download/v1.0.3/fribidi-1.0.3.tar.bz2
...
%prep
%setup -q -n fribidi-1.0.3
pushd ..
cp -a fribidi-1.0.3 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1526525039
